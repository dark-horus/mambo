...
<?php include( '../default/page/end_header.php' ); ?>
  ...
  <source src="video/Q8.mp4" type="video/mp4" />
  <source src="video/Q8.webm" type="video/webm" />
  <source src="video/Q8.ogv" type="video/ogg" />
...
<section>
                     <div id="container" class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="row">  
                                ...
                                <button class='lined thin' onclick="location.href='questions3_Q5.php'">Vous identifiez-vous à l’un des personnages de votre livre, et pourquoi ?</button>
                            </div>

                             <div class="col-sm-12 col-md-4 col-lg-4">
                                <button class='lined thin' onclick="location.href='questions3_Q10.php'">Quels liens vous unissent à la ville de Madrid et pourquoi l’avoir choisie pour raconter votre histoire ?</button>
                            </div>

                             <div class="col-sm-12 col-md-4 col-lg-4">
                                <button class='lined thin' onclick="location.href='questions3_Q11.php'">Pourquoi avoir choisi le vin  “Don Melchor” de “concha y toro”, est-il représentatif du Chili ou est-ce un choix plus personnel?</button>
                            </div>
