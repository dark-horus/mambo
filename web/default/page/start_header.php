...
if ($dossier != null) {
    switch ($dossier) {
        ...
        case "lapin":
			...
			$current = '<li class="col-md-12"><a href="#" >Étape en cours : '.$dossier.'</a></li>';
            $consigne ="Vous n'êtes ni Christophe Colomb ni au 15ème siècle, mais explorez le vaste monde de l'art culinaire de <em>Mambo Canaille</em> et mettez la main à la pâte en ajoutant votre recette à ce délicieux planisphère.";
			break;
        case "vin":
        ...
        case "ferrari":
			...
			$consigne ="A bord de la Ferrari d’Alejandro, retracez l’histoire du pays natal de l’auteur de <em>Mambo Canaille</em>. ";
			break;
		case "profil":
			$titre = "Votre profil";
