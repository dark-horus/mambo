    ...
    switch ($dossier) {
        case "crotte":
            $titre = "Expulsez Mary Carmen !";
			 $next = '<li class="col-md-12"><a href="../poitrine/">Étape suivante<br />Poitrine</a></li>';
        ...
        case "lapin":
			...
			$next = '<li class="col-md-12"><a href="../ours">Étape suivante<br />Ours</a></li>';
        ...
        case "poitrine":
			...
			$next = '<li class="col-md-12"><a href="../ferrari/index.html">Étape suivante<br />Ferrari</a></li>';
        ...
        case "immeuble":
			...
			$next = '<li class="col-md-12"><a href="../ordinateur">Étape suivante<br />Ordinateur</a></li>';
        ...
        case "gaspacho":
			...
			$next = '<li class="col-md-12"><a href="../hotel">Étape suivante<br />Hôtel</a></li>';
			$before = '<li class="col-md-12 "><a href="#">Aucune étape<br />précédente</a></li>';
        ...
        case "ferrari":
			...
			$before = '<li class="col-md-12"><a href="../poitrine/">Etape précédente<br />Poitrine</a></li>';
